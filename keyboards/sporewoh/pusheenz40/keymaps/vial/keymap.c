...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ortho_4x10(
    ...
    KC_ESCAPE, KC_LGUI, LCTL_T(KC_TAB),  MO(2), KC_SPACE, MO(1), LSFT_T(KC_BACKSPACE), KC_LEFT_SHIFT,   KC_LALT, KC_ENTER),
  [1] = LAYOUT_ortho_4x10(
    ...
    KC_NO,     KC_NO,    KC_NO, MO(3),  KC_NO,     KC_NO,   KC_NO,   KC_BACKSLASH, KC_NO,    KC_NO),
  [2] = LAYOUT_ortho_4x10(
  ...
  [3] = LAYOUT_ortho_4x10(
    ...
    KC_NO, MAGIC_SWAP_LCTL_LGUI, MAGIC_UNSWAP_LCTL_LGUI, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO),
};
